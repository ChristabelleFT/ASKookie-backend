...
(4, 'faculties', 'user0', 'Why choose SDE?', 'user0', 'because it is a very good faculty', ''),
(5, 'exchange_noc', 'user0', 'What should I prepare for Exchange?', 'user0', 'bags', ''),
...
(16, 'others', 'user0', 'Why is NUS good?', NULL, NULL, ''),
(17, 'exchange_noc', 'user0', 'What is the difference between exchange and NOC?', NULL, NULL, ''),
(18, 'others', 'user0', 'Should I go to NUS??', NULL, NULL, ''),
(19, 'student_life', 'user0', 'Is studying in NUS stressful?', NULL, NULL, ''),
(20, 'accommodation', 'user0', 'Which accommodation in NUS should I choose?', NULL, NULL, ''),
(21, 'student_life', 'user0', 'How is an international student\'s experience in NUS?', NULL, NULL, ''),
(22, 'others', 'user0', 'Where is the best place to study in NUS?', NULL, NULL, ''),
(23, 'others', 'user0', 'Where is starbucks in NUS?', NULL, NULL, ''),
(24, 'others', 'user0', 'Where can I see NUS map?', NULL, NULL, ''),
(25, 'others', 'user0', 'How to see NUS Bus location in real time?', NULL, NULL, ''),
(26, 'student_life', 'user0', 'How is Life in SOC?', NULL, NULL, ''),
(27, 'others', 'user0', 'Where should I go if my matriculation card is missing?', NULL, NULL, ''),
(28, 'faculties', 'user0', 'Where is LT16?', NULL, NULL, '');
